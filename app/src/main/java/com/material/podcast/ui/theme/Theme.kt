...
// Easter egg — deep gothic scheme; always dark. Every surface belongs to the Lands Between.
// Void-black depths, rune-gold radiance, bloodflame crimson, engraved iron outlines.
private val EldenRingDark = darkColorScheme(
    // Primary — tarnished rune-gold, luminous against the void
    primary = Color(0xFFD4A843),          onPrimary = Color(0xFF150900),
    primaryContainer = Color(0xFF3C2500), onPrimaryContainer = Color(0xFFF5D87E),
    // Secondary — weathered ash-stone, the bones of the Lands Between
    secondary = Color(0xFFAA9878),        onSecondary = Color(0xFF140E04),
    secondaryContainer = Color(0xFF2C2214), onSecondaryContainer = Color(0xFFDECAA8),
    // Tertiary — bloodflame crimson, the fire of the Erdtree's wrath
    tertiary = Color(0xFFE05252),         onTertiary = Color(0xFF1C0303),
    tertiaryContainer = Color(0xFF5C1818), onTertiaryContainer = Color(0xFFF5ADAD),
    // Void-black background — deeper than night, touched by the forgotten stars
    background = Color(0xFF07060B),       onBackground = Color(0xFFEDE4D5),
    surface = Color(0xFF07060B),          onSurface = Color(0xFFEDE4D5),
    // Surface hierarchy — each step warmer, as embers glow through cracked stone
    surfaceVariant = Color(0xFF221C12),   onSurfaceVariant = Color(0xFFC4B49A),
    surfaceContainerLowest = Color(0xFF030208),
    surfaceContainerLow    = Color(0xFF0D0B09),
    surfaceContainer       = Color(0xFF131009),
    surfaceContainerHigh   = Color(0xFF1E1910),
    surfaceContainerHighest= Color(0xFF2C2418),
    // Outlines — aged iron etched with gold-dust runes
    outline = Color(0xFF7A6848),          outlineVariant = Color(0xFF3E3220),
    // Error — the deep crimson of scarlet rot
    error = Color(0xFFFF6B6B),            onError = Color(0xFF2A0000),
    errorContainer = Color(0xFF6B1414),   onErrorContainer = Color(0xFFFFCDD2),
)
...
enum class AppThemeColor(
    ...
    EldenRing("Elden Ring", Color(0xFFD4A843), EldenRingDark, EldenRingDark),
}
